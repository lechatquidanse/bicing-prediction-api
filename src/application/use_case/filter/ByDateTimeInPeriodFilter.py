"""
Description of a filter for datetime list generated at a frequency
"""
import datetime
...
class ByDateTimeInPeriodFilter:
    def __init__(self, period_date_start: datetime, period_date_end: datetime, frequency: str):
        self._validate(period_date_start, period_date_end)
    ...
    @staticmethod
    def _validate(period_date_start: datetime, period_date_end: datetime):
